...
class Ui_sendEmail(object):
    def setupUi(self, sendEmail):
        ...
        self.dont_sent_btn = QtGui.QPushButton(self.widget1)
        self.dont_sent_btn.setObjectName(_fromUtf8("dont_sent_btn"))
        self.buttons.addWidget(self.dont_sent_btn)
    ...
    def retranslateUi(self, sendEmail):
        ...
        self.dont_sent_btn.setText(_translate("sendEmail", "Don\'t Send", None))
